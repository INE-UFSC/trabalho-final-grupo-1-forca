...
print(os.path.join("..", "assets", "jogador.png"))

#carregando imagem do jogador
JOGADOR = pygame.transform.scale(pygame.image.load(os.path.join(BASE_DIR, "assets", "jogador.png")), (WH_JOGADOR, WH_JOGADOR))
#carregando imagem dos aliens inimigos
ALIEN_1 = pygame.transform.scale(pygame.image.load(os.path.join(BASE_DIR, "assets", "alien_1.png")), (WH_INIMIGO, WH_INIMIGO))
ALIEN_2 = pygame.transform.scale(pygame.image.load(os.path.join(BASE_DIR, "assets", "alien_2.png")), (WH_INIMIGO, WH_INIMIGO))
ALIEN_3 = pygame.transform.scale(pygame.image.load(os.path.join(BASE_DIR, "assets", "alien_3.png")), (WH_INIMIGO, WH_INIMIGO))
...
LASER_4 = pygame.image.load(os.path.join(BASE_DIR, "assets", "laser_4.png"))

#carregando imagem do plano de funo
PLANO_DE_FUNDO = pygame.transform.scale(pygame.image.load(os.path.join(BASE_DIR, "assets", "plano_de_fundo.png")), (WIDTH, HEIGHT))
